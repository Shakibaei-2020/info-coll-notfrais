...
public class notedefrais {
 ...
 static ArrayList<notedefrais> ListNote = new ArrayList<notedefrais>();	
	...
	public void deleteNoteDeFrais(String p) {
	...
	public void updateNoteDeFrais(String p) {
	...
	public  void trieTouteDate() throws ParseException{
	...
	public  void sommeNoteDeFraisTotal() {
		int sum = 0;
	...
	public  void fraisParAnnee() throws ParseException {
		
		 Scanner sc = new Scanner(System.in); 
		 System.out.println("Saisir année souhaité");
		...
		System.out.println("nombre de personne avec frais lors de cette année"+nbpersonne);
		System.out.println("la somme total pour l'année "+ p + "est de "+ sum);
	...
	public void fraisParMois() throws ParseException {
		 ...
		 Scanner sc = new Scanner(System.in); 
		 System.out.println("Saisir mois souhaité");
	...
	public static void fraisParMoisEtAnnee() throws ParseException {
		 ...
		 System.out.println("Saisir mois souhaité");
	        int p = sc.nextInt();
	        System.out.println("Saisir annee souhaité");
	        int t = sc.nextInt();
	...
	public String toString() {
		return "notedefrais [nom=" + nom + ", somme=" + somme + ", raison=" + raison + ", date=" + date + "]";
	}
